    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0 }}>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", opacity: playing ? 0.6 : 1, transition: "opacity 0.5s" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ position: "relative", width: 220, height: 90, margin: "0 auto" }}>
                ...
                {/* Am chord dots */}
                {[
                  { fret: 1, string: 1 }, // A string, fret 1
                  { fret: 2, string: 2 }, // D string, fret 2
                  { fret: 2, string: 3 }, // G string, fret 2
                ].map((dot, i) => (
                  <motion.div
                    key={i}
                    initial={{ scale: 0 }}
          ...
          {/* Big play button (only when paused and not started) */}
          <AnimatePresence>
            {!playing && (
              <motion.div
      ...
      <div style={{
        ...
        borderRadius: "0 0 4px 4px", padding: "14px 18px",
